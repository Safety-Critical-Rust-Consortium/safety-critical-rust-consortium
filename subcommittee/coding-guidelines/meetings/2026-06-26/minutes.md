...
3. Solicit availability for RustConf 2026 SCRC Room (Pete)
- Please put availability on this [LettuceMeet](https://lettucemeet.com/l/oYlvM)  
4. The SCRC as a member organization of the Rust Commercial Network (RCN)
...
5. Draft document for usage of standards documents
...
6. Discuss possible 2-3 coding guidelines to choose for Clippy lints (Pete)
- How've we done in looking into these?
7. First version of MISRA C \+ CERT C Appendices [live](https://coding-guidelines.arewesafetycriticalyet.org/appendices/standards-matrices/index.html)
- Pete _must still_ mine these appendices for creating issues for contributors
...
9. Interest in the MISRA C++ mapping (Pete)  
...
10. Review batches for [CERT C  Rust Mapping](https://github.com/rustfoundation/safety-critical-rust-coding-guidelines/issues/336) (Pete)  
- Let's review again, to get some feedback on batch 2  
