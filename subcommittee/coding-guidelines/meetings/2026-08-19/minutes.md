...
4. Working session: continue reviewing the MISRA C++:2023 to Rust coding guidelines mapping (Mira / Pete)  
   ...
   - **Group A \- mappings applicable to Rust in general**  
     ...
     - [https://meet.google.com/gvv-kujx-oyh](https://meet.google.com/gvv-kujx-oyh)  
     - Group:  
       1. Oreste Bernardi ⛰️  
       2. Michael Henn 👍  
       3. William Barsse 👋  
   ...
   - **Group B \- mappings additionally applicable in the presence of unsafe code**  
     ...
     - [https://meet.google.com/awc-dxnn-meg](https://meet.google.com/awc-dxnn-meg)  
     - Group:  
       1. Daniel Dia 💽  
       2. Kangwon Lee 🤖  
       3. Pete LeVasseur 🌊  
...
- Splitting in two teams to review rule mappings.  
- Reviewed the following rules:  
  - 10.1.1, 10.2.1, 10.2.3,  
  - 10.1.2, 10.4.1, 11.6.1, 11.6.2, 12.3.1, and 15.1.4
