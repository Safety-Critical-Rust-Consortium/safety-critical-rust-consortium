...
5. Update on Eclipse iceoryx2 `// Safety:` comments and Rust Abstract Machine narrative (Andreas Weiss)
   ...
   - Update on work to add `// Safety:` comments to iceoryx2's `unsafe` usages, citing normative Rust documentation where possible and identifying gaps where it is not
...
6. Working session, if time: continue reviewing the MISRA C++:2023 to Rust coding guidelines mapping (Mira / Pete)
